...
import { getFallbackMentorResponse } from "./src/lib/mentorEngine";
...
// Strategic fallback responses are handled via getFallbackMentorResponse imported from ./src/lib/mentorEngine
